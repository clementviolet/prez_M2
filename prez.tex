...
\usepackage{geometry}
\geometry{paperwidth=160mm, paperheight=115mm}
...
\begin{document}
  ...
  \begin{frame}{Niche environnementale}
	...
	Données faunistiques issues du \emph{REBENT} :~\citep{Boye_2019a}
	\begin{itemize}
	...
	Données environnementales 7 variables : \includegraphics[scale=0.2]{figs/noun_Hot.png}, \includegraphics[scale=0.2]{figs/noun_Wind.png}, \includegraphics[scale=0.2]{figs/noun_Salt.png}, \includegraphics[scale=0.2]{figs/noun_wave.png}, \includegraphics[scale=0.2]{figs/noun_sand.png}
		\begin{figure}[t]
		\begin{center}
			\includegraphics[scale = 0.14]{figs/site_map.png} 
		\end{center}
	\end{figure}
	\end{frame}
	...
	\begin{figure}[t]
	\begin{center}
		\includegraphics[scale =0.6]{figs/SR2-density-method-2.png}%
	\end{center}
	\end{figure}
	\pause
